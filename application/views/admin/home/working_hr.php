...
<!--=========================================================================-->
    ...
    <div class="content">
        ...
        echo form_open_multipart('admin_controller/edit_working_hr'); 
...
<div class="inpt" style="display:flex;">
    <input type="text" name="title" value="<?= isset($working_hr->title) ? $working_hr->title : ''  ?>" /><!--  -->
...
<label>Content:</label>
<div class="inpt" style="display:flex;">
    <textarea name="content"> <?= isset($working_hr->content) ? $working_hr->content : '' ?> </textarea> 
    <span style="color:red;">
      <?= form_error('content'); ?>
    </span>
</div>
