...
<!--=========================================================================-->
    ...
    <div class="content">
        ...
        echo form_open_multipart('admin_controller/edit_contactUs'); 
...
<div class="inpt" style="display:flex;">
    <input type="text" name="title" value="<?php echo isset($contactUs->title) ? $contactUs->title : ''  ?>" /><!--  -->
...
<label>Content:</label>
<div class="inpt" style="display:flex;">
    <textarea name="content"> <?php echo isset($contactUs->content) ? $contactUs->content : '' ?> </textarea> 
    <span style="color:red;">
      <?= form_error('content'); ?>
    </span>
</div>
