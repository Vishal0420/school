...
<!--=========================================================================-->
    ...
    <div class="content">
        ...
        echo form_open_multipart('admin_controller/edit_why_us'); 
...
<div class="inpt" style="display:flex;">
    <input type="text" name="title" value= "<?= $why_us->title; ?>" /><!--  -->
...
<div class="inpt" style="display:flex;">
    <textarea name="description"> <?= $why_us->description; ?> </textarea>  
    <span style="color:red;">
