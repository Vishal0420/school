...
$config['smtp_user'] = 'vc981@gmail.com'; // Your Gmail email address
$config['smtp_pass'] = 'vska yrkx bxiw kgsy'; // Your Gmail password
...
$config['from_email'] = 'Technologies@gmail.com';    // just for lable not displayed anywhere in the received email
